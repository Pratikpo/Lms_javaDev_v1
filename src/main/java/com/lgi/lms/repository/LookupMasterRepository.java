...
public interface LookupMasterRepository {
    ...
    List<DistrictCovered> findDistrictsByStateId(Long stateId);
    
    List<BranchCovered> findAllBranchCovered();
	
    BranchCovered findBranchCoveredById(Long id);
    
   List<BranchCovered> findAllBranchByDistrictStateId(Long districtStateId);
    ...
    List<ReportingPerson> findAllReportingPersonByRoleId(Long roleId);
